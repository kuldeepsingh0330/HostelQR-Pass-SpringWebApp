...
<table class="table table-hover text-center">
  <thead style="background-color: #afd7ff;">
    <tr>
      ...
      <th scope="col">Premission Granted</th>
...
for(HostlerDetail hostlermanager : result){
	boolean b = hostlermanager.isPermissionGranted();
	String currStatus = "pending";
	String isGranted = "Not yet";
	...
	if(b){
		...
		isGranted = "Granted";
		completionTime = "---------";
		grantBy = hostlermanager.getGrantedByempName();
		if(hostlermanager.getCompletionTime() != null){
			currStatus = "completed";
			completionTime = ""+hostlermanager.getCompletionTime();
		}
	}
...
%>
    ...
    <tr>
      ...
      <td><%=hostlermanager.getLocation() %></td>
