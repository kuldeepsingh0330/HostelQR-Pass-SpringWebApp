    ...
    <div class="col-md-5">
      <div class="card">
        <div class="card-body">
          ...
          <form action="empvalidate" method="post">
            <div class="mb-3">
              <label for="inputEmail" class="form-label">Email</label>
              <input type="email" class="form-control" name="empEmail" id="inputEmail" placeholder="Enter email" required="required">
            </div>
            <div class="mb-5">
              <label for="inputPassword" class="form-label">Password</label>
              <input type="password" class="form-control" name="empPassword" id="inputPassword" placeholder="Enter password" required="required">
            </div>
